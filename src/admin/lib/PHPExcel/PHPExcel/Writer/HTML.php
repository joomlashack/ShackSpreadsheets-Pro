    ...
    public function buildCSS($generateSurroundingHTML = true)
    {
        ...
        foreach ($sheets as $sheet) {
            ...
            if ($rowDimension->getRowHeight() == -1) {
                $pt_height = PHPExcel_Shared_Font::getDefaultRowHeightByFont($this->phpExcel->getDefaultStyle()
                    ->getFont());
            } else {
...
//        $css = $this->mapBorderStyle($pStyle->getBorderStyle()) . ' #' . $pStyle->getColor()->getRGB();
        ...
        $css         = $borderStyle . ' #' . $pStyle->getColor()
                ...
                if ($cell instanceof PHPExcel_Cell) {
                    ...
                    if (!$this->useInlineCss) {
                        ...
                        if ($sharedStyle->getAlignment()
                                ->getHorizontal() == PHPExcel_Style_Alignment::HORIZONTAL_GENERAL
